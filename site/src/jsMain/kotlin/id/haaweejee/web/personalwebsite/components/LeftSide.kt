...
import id.haaweejee.web.personalwebsite.styles.ButtonStyle
import id.haaweejee.web.personalwebsite.styles.SocialIconStyle
    ...
    Column(
        ...
        Surface(
            modifier = Modifier
                ...
                .align(if (breakpoint <= Breakpoint.SM) Alignment.CenterHorizontally else Alignment.Start)
        ) {}
        SpanText(
            modifier = Modifier
                .fontFamily(Res.String.ROBOTO_REGULAR)
        ...
        Button(
            ...
            SpanText(
                modifier = Modifier
                    .fontSize(14.px)
                    .color(if (colorMode.isLight) Colors.White else Res.Theme.DARK_BLUE.color)
                    .fontWeight(FontWeight.Bold)
                    .fontFamily(Res.String.ROBOTO_REGULAR),
